...
i32 Window::get_width() const { return w; }

i32 Window::get_height() const { return h; }

SDL_Texture* Window::create_text(const std::string& text) {
    SDL_Surface* surface =
        TTF_RenderText_Blended(gAssets.font, text.data(), text.size(), SDL_Color(255, 255, 255, 255));
